...
function(ua_generate_datatypes)
    ...
    set(oneValueArgs NAME TARGET_SUFFIX TARGET_PREFIX OUTPUT_DIR FILE_XML FILE_CSV MEMBERS_EXTRAM_ATTR)
...
function(ua_generate_nodeset)
    ...
    if(UA_GEN_NS_AUTOLOAD)
        ...
        list(APPEND UA_NODESETINJECTOR_NAMES ${UA_GEN_NS_NAME})
        set_parent(UA_NODESETINJECTOR_SOURCE_FILES)
        set_parent(UA_NODESETINJECTOR_NAMES)
    endif()
endfunction()
