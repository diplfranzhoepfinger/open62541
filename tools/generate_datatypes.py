...
class CGenerator:
    def __init__(self, parser, inname, outfile, is_internal_types, gen_doc, namespaceMap, members_extram_attr=""):
        self.parser = parser
        self.inname = inname
...
generator = CGenerator(parser, inname, args.outfile, args.internal, args.gen_doc, namespaceMap, args.members_extram_attr)
